      ...
      <div className={`${styles.work__inner} container`}>
        <div className="heading">
          ...
          <p className="heading__subtitle">
            The development of such great projects requires a lot of responsibility and a systematic
            approach.
          </p>
          <p className="heading__subtitle">
          ...
          <li className={styles.work__item}>
            ...
            <div className={styles.work__content}>
              <p className={styles.work__text}>
                This phase allows to assess correctly the expected result and potential risks. This
                makes it possible to see the potential of the project and correctly allocate
                resources.
              </p>
